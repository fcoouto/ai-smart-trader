...
class SmartTrader:
    ...
    def validate_trading_session(self):
        ...
        if (now_utc.weekday() >= 4 and now_utc.hour >= 20) or now_utc.weekday() >= 5:
            ...
            # Waiting PB
            msg = "It's weekend! Go enjoy your life while I take a break... :)"
    ...
    def ocr_read_element(self, zone_id, element_id, context_id=None, type='string'):
        ...
        for attempt in range(1, 2):
            ...
            elif type == 'string_timeframe':
                config = '--psm 7 -c tessedit_char_whitelist="123456789mhd"'
            elif type == 'currency':
    ...
    def is_big_ass_candle(self, i=0):
        if self.change[i] > self.change_avg_15 * 3:
            return True
