...
# TRADING
TRADING_STRATEGIES = ['rsi_high_low', 'ema_rsi_50', 'ema_rsi_8020']
MODE_SIMULATION = 'simulation'
MODE_DEMO = 'demo'
MODE_LIVE = 'live'
MAX_TRADES_PER_POSITION = 3
MARTINGALE_MULTIPLIER = [1, 2.25, 1.50]
MARTINGALE_MULTIPLIER = [1, 2, 1.10]
AMOUNT_TRADES_TO_RECOVER_LOSSES = 3
INITIAL_TRADE_AMOUNT_MULTIPLIER_FOR_STOP_LOSS = 25
